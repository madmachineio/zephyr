...
static int mm_swiftio_init(const struct device *dev)
{
	...
	IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_03_LPSPI4_SCK, 0x130B0u | IOMUXC_SW_PAD_CTL_PAD_PUE(2));

	IOMUXC_SetPinMux(IOMUXC_GPIO_B1_15_GPIO2_IO31, 0U);
	IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_15_GPIO2_IO31,
			    IOMUXC_SW_PAD_CTL_PAD_PKE_MASK |
			    IOMUXC_SW_PAD_CTL_PAD_SPEED(2) |
			    IOMUXC_SW_PAD_CTL_PAD_DSE(6));
	IOMUXC_SetPinMux(IOMUXC_GPIO_B1_14_GPIO2_IO30, 0U);
	IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_14_GPIO2_IO30,
			    IOMUXC_SW_PAD_CTL_PAD_PKE_MASK |
			    IOMUXC_SW_PAD_CTL_PAD_SPEED(2) |
			    IOMUXC_SW_PAD_CTL_PAD_DSE(6));
